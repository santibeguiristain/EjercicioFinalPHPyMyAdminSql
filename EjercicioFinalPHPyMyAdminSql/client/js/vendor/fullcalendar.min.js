! function(t) {
	...
	var r = "6.2.4",
		o = {
			...
			registerPlugin: function(t, e) {
				var r = e ? i(e) : n(t.constructor).toLowerCase();
			...
			unregisterPlugin: function(t) {
				var e = i(n(t.$element.data("zfPlugin").constructor));
			...
			reInit: function(n) {
				var e = n instanceof t;
				try {
					if (e) n.each(function() {
							...
							a = {
								object: function(n) {
									n.forEach(function(n) {
										n = i(n), t("[data-" + n + "]").foundation("_init")
									})
								},
								string: function() {
									n = i(n), t("[data-" + n + "]").foundation("_init")
			...
			reflow: function(n, i) {
				...
				t.each(i, function(i, o) {
					var a = r._plugins[o],
						u = t(n).find("[data-" + o + "]").addBack("[data-" + o + "]");
					u.each(function() {
						var n = t(this),
							i = {};
						if (n.data("zfPlugin")) return void console.warn("Tried to initialize " + o + " on an element that already has a Foundation plugin.");
						...
						try {
							n.data("zfPlugin", new a(t(this), i))
						} catch (r) {
							console.error(r)
						} finally {
							return
			...
			transitionend: function(t) {
				...
				for (var r in e) "undefined" != typeof i.style[r] && (n = e[r]);
	...
	var a = function(e) {
		var i = typeof e,
			...
			a = t(".no-js");
		if (r.length || t('<meta class="foundation-mq">').appendTo(document.head), a.length && a.removeClass("no-js"), "undefined" === i) o.MediaQuery._init(), o.reflow(this);
		else {
			...
			1 === this.length ? s[e].apply(s, u) : this.each(function(n, i) {
				s[e].apply(t(i).data("zfPlugin"), u)
			})
		}
		return this
	};
	...
	var e = {
		...
		_init: function() {
			...
			e = n(r);
			for (var o in e) e.hasOwnProperty(o) && i.queries.push({
				name: o,
		...
		atLeast: function(t) {
			var n = this.get(t);
			return n ? window.matchMedia(n).matches : !1
		},
		get: function(t) {
		...
		_watcher: function() {
			...
			t(window).on("resize.zf.mediaquery", function() {
				var e = n._getCurrentSize(),
					i = n.current;
				e !== i && (n.current = e, t(window).trigger("changed.zf.mediaquery", [e, i]))
			})
		}
	};
